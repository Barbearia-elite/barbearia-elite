          ...
          <div className="flex flex-col gap-32">
            {barbers.map((barber, index) => (
              ...
              >
                ...
                >
                  <div className="aspect-[3/4] lg:aspect-square overflow-hidden relative">
                    <img 
                      src={barber.image} 
                      alt={barber.name} 
                      loading="lazy"
                    ...
                    />
                    <div className="absolute inset-0 bg-matte/30 mix-blend-multiply group-hover:bg-crimson/20 transition-colors duration-500"></div>
                  </div>
                  {/* Decorative element */}
